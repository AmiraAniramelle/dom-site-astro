...
export const aboutPageData: AboutPageData = {
  seo: {
    ...
    description:
      'Исследователь системной природы жизни, автор бестселлеров, создатель метода DOM. 300 000+ слушателей, 8+ лет практики.',
  ...
  hero: {
    ...
    stats: [
      ...
      {
        value: '2',
        label: 'книги-бестселлера',
      },
      {
        value: '6',
        label: 'внешний DOM и внутренний DOM',
      },
    ],
  },
  whoToday: {
