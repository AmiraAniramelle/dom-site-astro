...
export const reviewsSectionData = {
  ...
  reviews: [
    { id: 'story-1', name: 'Екатерина Лебедева', role: 'Предприниматель', city: 'Москва', text: 'Я перестала жить в тревоге о деньгах и впервые выстроила спокойный, устойчивый ритм жизни.', fullText: 'До DOM у меня было постоянное внутреннее напряжение: я много работала, но ощущала, что всё держится на усилии.\n\nВ процессе я увидела, как мои внутренние состояния влияли на решения в бизнесе и отношениях с командой. После нескольких месяцев практики появилось ощущение опоры, ясности и порядка.\n\nСейчас я принимаю решения без паники, выстроила стабильную финансовую систему и перестала жить в режиме «пожара». Главное изменение — вернулось чувство уважения к себе и своей жизни.', photo: 'https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?auto=format&fit=crop&w=900&q=80' },
    { id: 'story-2', name: 'Андрей Смирнов', role: 'Руководитель проектов', city: 'Санкт-Петербург', text: 'DOM помог мне выйти из выгорания и научиться строить отношения без постоянного внутреннего конфликта.', fullText: 'Я пришёл в DOM в состоянии усталости и раздражения: работа, семья, ответственность, а внутри — пустота.\n\nПрактики метода дали понятную структуру: как видеть свои реакции, как возвращаться в центр и как не разрушать отношения импульсивными действиями. Это было не про «мотивацию», а про системную пересборку.\n\nЧерез время я заметил, что дома стало больше спокойствия, в работе — больше фокуса, а в голове — меньше шума. Для меня DOM стал точкой перехода в зрелую позицию.', photo: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=900&q=80' },
    { id: 'story-3', name: 'Марина Ковалёва', role: 'Психолог', city: 'Казань', text: 'Я снова почувствовала вкус к жизни и перестала откладывать себя «на потом».', fullText: 'В какой-то момент я поняла, что помогаю другим, но сама живу без внутренней радости и энергии.\n\nВ DOM меня зацепила глубина и честность подхода: не убегать от реальности, а выстраивать её изнутри. По шагам я восстановила связь с собой, пересобрала приоритеты и вернула ощущение живого интереса к жизни.\n\nСейчас у меня больше внутренней тишины, больше любви к себе и намного больше сил для работы и близких отношений.', photo: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=900&q=80' },
  ],
  cta: { text: 'Читать все истории', url: '/ru/reviews/' },
  flowTitle: 'Тысячи участников проходят трансформацию с DOM',
  flowCards: [
    { name: 'Ольга Романова', city: 'Екатеринбург', result: 'Вернула внутреннюю опору и спокойствие', photo: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=900&q=80' },
    { name: 'Дмитрий Волков', city: 'Новосибирск', result: 'Вышел из выгорания и собрал фокус в работе', photo: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=900&q=80' },
    { name: 'Наталья Орлова', city: 'Сочи', result: 'Наладила отношения с собой и близкими', photo: 'https://images.unsplash.com/photo-1544717302-de2939b7ef71?auto=format&fit=crop&w=900&q=80' },
    { name: 'Игорь Сорокин', city: 'Казань', result: 'Перестроил финансовые сценарии', photo: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=600&q=80' },
    { name: 'Елена Громова', city: 'Москва', result: 'Снизила тревожность и обрела ясность', photo: 'https://images.unsplash.com/photo-1488426862026-3ee34a7d66df?auto=format&fit=crop&w=900&q=80' },
    { name: 'Максим Беляев', city: 'Самара', result: 'Укрепил ментальную устойчивость', photo: 'https://images.unsplash.com/photo-1504593811423-6dd665756598?auto=format&fit=crop&w=900&q=80' },
  ],
};
